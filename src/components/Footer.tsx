    ...
    <footer className="bg-black text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand Section */}
          <div>
            <h3 className="text-xl font-outfit font-semibold text-gold mb-4 tracking-tight">Tierra Querida</h3>
            <p className="text-gray-400 mb-4 font-body text-sm leading-relaxed">
